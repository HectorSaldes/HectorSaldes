...
import {
	SiJavascript, SiNetlify, SiNodedotjs, SiMongodb, SiSpring,
				...
				<div>
					...
					<div>
						...
						<div className='flex justify-around flex-wrap text-center'>
							<CartoonCardOutlined Background='bg-[#13111c]'
												 Items={() => (<SiRailway size='40' color='#fff' />)} />
							<CartoonCardOutlined Background='bg-[#202020]'
												 Items={() => (<FaReact size='40' color='5ccfee' />)} />
							<CartoonCardOutlined Background='bg-[#202020]'
												 Items={() => (<SiJavascript size='40' color='yellow' />)} />
							<CartoonCardOutlined Background='bg-[#1e1e1e]'
												 Items={() => (<SiFigma size='40' color='#f34e1e' />)} />
							<CartoonCardOutlined Background='bg-[#2f393b]'
												 Items={() => (<SiNetlify size='40' color='#00beae' />)} />
							<CartoonCardOutlined Background='bg-[#303030]'
												 Items={() => (<SiNodedotjs size='40' color='#7aa61b' />)} />
							<CartoonCardOutlined Background='bg-[#1e2f39]'
												 Items={() => (<SiMongodb size='40' color='#108b4b' />)} />
							<CartoonCardOutlined Background='bg-[#151c2c]'
												 Items={() => (<SiTailwindcss size='40' color='#14b4c0' />)} />
							<CartoonCardOutlined Background='bg-[#219945]'
												 Items={() => (<SiSpring size='40' color='white' />)} />
							<CartoonCardOutlined Background='bg-[#ed2025]'
												 Items={() => (<DiJava size='40' color='white' />)} />
							<CartoonCardOutlined Background='bg-[#f1491c]'
												 Items={() => (<SiHtml5 size='40' color='white' />)} />
							...
							<CartoonCardOutlined Background='bg-[#7a11f7]'
												 Items={() => (<FaBootstrap size='40' color='white' />)} />
							<CartoonCardOutlined Background='bg-[#26bec9]'
												 Items={() => (<SiCanva size='40' color='white' />)} />
							<CartoonCardOutlined Background='bg-[#000]'
												 Items={() => (<SiSpotify size='40' color='#1ed760' />)} />
							<CartoonCardOutlined Background='bg-[#000]'
												 Items={() => (<GrMedium size='40' color='white' />)} />
							<CartoonCardOutlined Background='bg-[#000]'
												 Items={() => (<SiUnsplash size='40' color='white' />)} />
						</div>
					</div>
				</div>
			</div>
